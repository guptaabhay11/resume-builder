...
exports.uploadPdf = exports.logout = exports.getUserInfo = exports.login = exports.getAllUser = exports.getUserById = exports.deleteUser = exports.editUser = exports.updateUser = exports.createUser = void 0;
...
exports.uploadPdf = (0, express_async_handler_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const file = req.file;
    if (!file) {
        res.status(400).send((0, response_helper_1.createResponse)({}, "File not found"));
        return;
    }
    const result = yield userService.uploadPdf(userId, file);
    res.send((0, response_helper_1.createResponse)(result));
}));

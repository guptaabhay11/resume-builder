...
exports.uploadPdf = exports.getUserByEmail = exports.getAllUser = exports.getUserById = exports.deleteUser = exports.editUser = exports.updateUser = exports.createUser = void 0;
...
const uploadPdf = (id, file) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield user_schema_1.default.findByIdAndUpdate(id, { $push: { pdf: file.path } }, { new: true });
    return result;
});

...
const LiveResumePreview: React.FC<{ data: ResumeData }> = ({ data }) => {
  return (
    <div className="w-full h-full flex overflow-hidden">
      <div className="flex flex-col md:flex-row w-full min-h-full font-sans text-sm">
        {/* Sidebar */}
        <aside className="md:w-[30%] w-full bg-[#2E3B55] text-white p-5 overflow-y-auto">
        ...
        {/* Main Content */}
        <main className="md:w-[70%] w-full bg-white p-5 overflow-y-auto">
          {/* Summary */}
